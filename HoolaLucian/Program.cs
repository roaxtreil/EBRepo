...
namespace HoolaLucian
{
    public class Program
    {
        ...
        {
            Menu = MainMenu.AddMenu("Hoola Lucian", "hoola");
        ...
        private static void OnDoCastDelayed(GameObjectProcessSpellCastEventArgs args)
        {
            ...
            if (args.Target is AIHeroClient)
            {
                ...
                if (Orbwalker.ActiveModesFlags.HasFlag(Orbwalker.ActiveModes.Combo) && target.IsValid)
                {
                    ...
                    if (E.IsReady() && !AAPassive && Getslidervalue(Combo, "CE") == 2) EloBuddy.Player.CastSpell(SpellSlot.E, Player.Position.Extend(target.Position, 50));
                ...
                if (Orbwalker.ActiveModesFlags.HasFlag(Orbwalker.ActiveModes.Harass) && target.IsValid)
                {
                    ...
                    if (E.IsReady() && !AAPassive && Getslidervalue(HarassMenu, "HE") == 1) EloBuddy.Player.CastSpell(SpellSlot.E, Player.Position.Extend(Game.CursorPos, 50));
                    if (E.IsReady() && !AAPassive && Getslidervalue(HarassMenu, "HE") == 2) EloBuddy.Player.CastSpell(SpellSlot.E, Player.Position.Extend(target.Position, 50));
            ...
            if (args.Target is Obj_AI_Minion && args.Target.IsValid)
            {
                if (Orbwalker.ActiveModesFlags.HasFlag(Orbwalker.ActiveModes.LaneClear))
                {
                    ...
                    {
                        if (E.IsReady() && !AAPassive && Getcheckboxvalue(JungleClear, "JE")) EloBuddy.Player.CastSpell(SpellSlot.E, Player.Position.Extend(Game.CursorPos, 70));
