...
namespace Kappalista
{
    ...
    /// </summary>
    public enum CollisionableObjectsEx
    {
        /// <summary>
        /// Minions.
        /// </summary>
    ...
    public class PredictionInput
    {
        ...
        /// </summary>
        public CollisionableObjectsEx[] CollisionObjectsEx =
        {
        ...
        /// The skillshot type.
        /// </summary>
        public SkillshotTypeEx TypeEx = SkillshotTypeEx.SkillshotLine;
    ...
    public class PredictionOutput
    {
        ...
        /// </summary>
        public HitChanceEx Hitchance = HitChanceEx.Impossible;
    ...
    /// </summary>
    public static class PredictionEx
    {
        /// <summary>
        ...
        public static PredictionOutput GetPrediction(Obj_AI_Base unit,
            ...
            float radius,
            float speed,
            CollisionableObjectsEx[] collisionable)
        {
            return
                GetPrediction(
                    new PredictionInput
                    {
                        ...
                        Radius = radius,
                        Speed = speed,
                        CollisionObjectsEx = collisionable
                    });
        }
    ...
    internal static class PathTracker
    {
        ...
        private static void AIHeroClient_OnNewPath(Obj_AI_Base sender, GameObjectNewPathEventArgs args)
        {
            ...
            var newPath = new StoredPath { Tick = Environment.TickCount, Path = args.Path.Select(x => x.To2D()).ToList() };
        ...
        public static double GetMeanSpeed(Obj_AI_Base unit, double maxT)
        {
            ...
            if (paths.Count > 0)
            {
                ...
                for (var i = 0; i < paths.Count - 1; i++)
                {
                    ...
                    {
                        distance += Math.Min(
                            (currentPath.Time - nextPath.Time) * unit.MoveSpeed, currentPath.PathLength());
                    }
                }
                ...
                {
                    distance += Math.Min(lastPath.Time * unit.MoveSpeed, lastPath.PathLength());
                }
            }
            else
            {
