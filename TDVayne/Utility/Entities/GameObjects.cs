// <copyright file="GameObjects.cs" company="EloBuddy">
//    Copyright (c) 2015 EloBuddy.
// 
...
namespace TDVayne.Utility.Entities
{
    ...
    public static class GameObjects
    {
        ...
        {
            get { return AttackableUnitsList; }
        }
        ...
        {
            get { return JungleLegendaryList; }
        }
        ...
        internal static void Initialize()
        {
            ...
            Loading.OnLoadingComplete += OnLoadingOnOnLoadingComplete;
        }

        private static void OnLoadingOnOnLoadingComplete(EventArgs args)
        {
                ...
                ObjectManager.Get<Obj_AI_Minion>()
                    .Where(
                        o =>
                            ...
                            !o.BaseSkinName.ToLower().Contains("trinket") && !o.BaseSkinName.Equals("gangplankbarrel")));
            ...
            WardsList.AddRange(
                ObjectManager.Get<Obj_AI_Minion>()
                    .Where(
                        o => o.BaseSkinName.ToLower().Contains("ward") || o.BaseSkinName.ToLower().Contains("trinket")));
