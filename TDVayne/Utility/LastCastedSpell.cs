...
namespace TDVayne.Utility
{
    ...
    public static class LastCastedSpell
    {
        ...
        private static void SpellbookOnCastSpell(Spellbook spellbook, SpellbookCastSpellEventArgs args)
        {
            if (spellbook.Owner.IsMe)
            {
                LastCastPacketSent = new LastCastPacketSentEntry(
                    args.Slot, TumbleExtensions.GameTickCount, (args.Target is Obj_AI_Base) ? args.Target.NetworkId : 0);
            }
        }
        ...
        private static void Obj_AI_Hero_OnProcessSpellCast(Obj_AI_Base sender, GameObjectProcessSpellCastEventArgs args)
        {
            ...
            {
                var entry = new LastCastedSpellEntry(args.SData.Name, TumbleExtensions.GameTickCount,
        ...
        public static int LastCastedSpellT(this Obj_AI_Base unit)
        {
            return CastedSpells.ContainsKey(unit.NetworkId)
                ...
                : (TumbleExtensions.GameTickCount > 0 ? 0 : int.MinValue);
        }
